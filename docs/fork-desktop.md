...
This desktop build adds optional per-bot Hindsight memory to upstream 0.1.71.
Its version is `0.1.71-hindsight.1`. A Git commit does not update an installed
...
The command creates `release/OpenMausBot-0.1.71-hindsight.1-arm64.dmg` using
...
4. Confirm About shows `0.1.71-hindsight.1`, check existing bots, and follow the
